...
<html>
    ...
    <body>
        <?php include 'nav.php' ;
        $array = Array('train', 'bureau', 'boulot', 'droit', 'ennuis', 'equipe', 'femme', 'femmes', 'fille', 'gendre', 'homme', 'hommes', 'maison', 'medecin', 'personne', 'telephone', 'travail', 'travaille', 'travailler', 'tue', 'tuer', 'ville', 'verite', 'vie');
        flush();
        ob_flush();
